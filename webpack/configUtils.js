...
const DEFINE_PLUGIN = new webpack.DefinePlugin({
  ...
  'process.env.STEEMCONNECT_CLIENT_ID': JSON.stringify(
    process.env.STEEMCONNECT_CLIENT_ID || 'pl-network',
  ),
  'process.env.STEEMCONNECT_REDIRECT_URL': JSON.stringify(
    process.env.STEEMCONNECT_REDIRECT_URL || 'https://pl.network/callback',
  ),
  ...
  'process.env.SIGNUP_URL': JSON.stringify(
    process.env.SIGNUP_URL || 'https://pl.network/polish/@santarius/dostepne-metody-rejestracji-na-steem',
  ),
